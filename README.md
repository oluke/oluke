...
- 🌱 I’m currently learning **machine learning techniques for DNA identification**.
- 📝 I regularly write articles on [Scholar](https://scholar.google.com/citations?user=BytuPMsAAAAJ&hl=en).
- 🛠️ I frequently use Python, along with Pandas, NumPy, and Scikit-Learn, to perform various data science tasks.
- ⚡ Fun fact: I am capable of holding my breath underwater for 50 meters.
